<template>
    <div class="offerPart">
        ...
        <div class="sidenav-part template main-content">
            ...
            <div class="panel-content mr-2 ml-2 mt-2 mb-2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="widget">
...
export default {
    ...
    methods: {
        ...
        onImage(file, index) {
            this.$service.awsPhotoUpload(file, (awsResponse) => {
         ...
         */
        getOneProduct() {
            service.getOneProd(this.$route.params.id, (response) => {
                if (!_.isEmpty(response)) {
                    this.productDetails = response.data
                    // if (this.productDetails.verifiedStatus === true) {
                    //     this.productDetails.preStatus = true
                    // } else {
                    //     this.productDetails.preStatus = false
                    // }
                } else {
                    this.productDetails = {}
                }
        ...
        changeShowImage(data, index) {
            if (data) {
                if (this.productDetails.images.length > 1) {
                    _.forEach(this.productDetails.images, (value, key) => {
                        const values = value
                        const keys = key
                        if (keys !== index) {
